...
const Typicons = require("react-icons/lib/ti");
...
class Button extends React.Component {
    render() {
        return (<a className="button outline light" href={this.props.href} target={this.props.target}>
            {this.props.children}
        </a>);
    }
}
...
const Block = props => (<Container padding={["bottom", "top"]} id={props.id} className={props.className} background={props.background}>
    <GridBlock align={props.align || "center"} contents={props.children} layout={props.layout}/>
</Container>);

const Features = props => (<Block background="shadow" layout="threeColumn" className="featureSection">
    {
        [
            {
...
const UnibeautifyCi = () => (<Block align="left" className="ubiCISection">
    {
        [
            {
...
const Showcase = props => {
    ...
    return (<div className="productShowcaseSection lightBackground paddingTop paddingBottom">
...
const LanguagesShowcase = () => {
    ...
    const showcase = siteConfig.languages.map((language, i) => {
        return (<a href={language.infoLink} key={i}>
            <img src={language.image} title={language.name}/>
            <br/> {language.name}
        </a>);
    });

    return (<div className="productShowcaseSection languages paddingBottom paddingTop">
